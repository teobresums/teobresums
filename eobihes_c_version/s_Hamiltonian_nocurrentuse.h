...
//  s_Hamiltonian.h
//
//  Created by Philipp Fleig on 22/11/2016.
//  Copyright © 2016 Philipp Fleig. All rights reserved.
//

#include "input_struc.h"

#ifndef s_Hamiltonian_h
#define s_Hamiltonian_h

//function [H, Heff, varargout]=EOB_Hamiltonian(r,pph,prstar)

vector<double> Hamiltonian(double y[],void *params){
    ...
    double jhat, Omega, ddotr, H, Heff, r_omega, Omg_orb;
    double dHeff_dr, dHeff_dprstar, dHeff_dpph;
...
//        f[0] = sqrtAbyB*one_H*dHeff_dprstar;
        ...
        dHeff_dpph = GS*S + (GSs + pphi*dGSs_dpph)*Sstar + pphi*A*uc2/Heff_orb;
    ...
    return {H,Heff,dHeff_dr,dHeff_dprstar,dHeff_dpph/*,Omega,ddotr,H,Heff,jhat,r_omega,Omg_orb*/};
}



#endif /* s_Hamiltonian_h */
