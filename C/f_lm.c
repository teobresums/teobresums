...
void f_lm(
    ...
    flm[6] = rholm[6]*rholm[6]*rholm[5]*rholm[6];
    flm[7] = rholm[7]*rholm[7]*rholm[5]*rholm[7];
    flm[8] = rholm[8]*rholm[8]*rholm[5]*rholm[8];
