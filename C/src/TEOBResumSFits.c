...
{  
  ...
  /* Equal-mass, equal-spin coefficients */
  const double p0 =  45.235903;
  const double n1 =  -1.688708;
  const double n2 =   0.787959;
  const double n3 =  -0.018080;
  const double n4 =   -0.001906;
  const double d1 =  -0.751479;
		  
  /* Other coefficients */
  const double p1 =  47.3756;
  const double p2 = -36.1964;
 ...
 *
 *   @param[out] nqc   : NQC coefficients
 *
 */
...
/**
 * Function: nr_mrg_fit_momg_bns
 * -----------------------------
 *  Fit for the merger frequency of BNS systems
 *  Eq.(2) and Tab. 2 of arxiv:1504.01764
 * 
 *  @param[out] omg_mrg : merger frequency
*/
 ...
 *  and its first derivative for BNS systems
 *  App. C of arxiv:2307.15125
*/
...
/**
 * Function: Breschi22_nr_mrg_fits_bns_template
 * --------------------------------------------
 *  Template function for BNS fits
 *  App. C of arxiv:2307.15125
 *  Eq, (19)-(21) of arxiv:2205.09112
*/
      ...
      double *sigmar, double *sigmai)
{
  ...
  eob_nqc_point_HM_peak22(A, dA, omg, domg);
  for(int j=0; j<knqcpeak22_size; j++){
    int k = knqcpeak22[j];
...
double eob_approxLR(const double nu) 
{
  ...
  const double r0 = 1.818461553848201e+00;
  const double r1 = 1.821043720041472e+00;
  return r0*x + r1;
}
 ...
 */
double get_mrg_timestep(double UNUSED(q), double UNUSED(chi1), double UNUSED(chi2))
{
  double dt = 0.1;
  // ...
  return dt;
 ...
 */
double get_mrg_timestop(double UNUSED(q), double UNUSED(chi1), double UNUSED(chi2))
{ 
  double tstop = 2.0;
