...
void eob_nqc_point_BHNS_HM(Dynamics *dyn, double *A_tmp, double *dA_tmp, double *omg_tmp, double *domg_tmp, double abh, double kt2, bool *bhns)
{
  ...
  a110= 6.16366162;//2.18216560;
  a111= 20.0054884;//-7.81136903;
  a120= -79.1693954;//9.19028477;
  a121= -9.54906343;//51.6252430;
  a210= -4.04853057;//-0.47829260;
  a211= 0.53465595;//0.55246591;
  a220= 17.2091642;//2.48857743;
  a221= -0.12706636;//-2.26730441;
  b110= -0.66082002;//2.49283807;
  b111= 6.26777099;//2.90349596;
