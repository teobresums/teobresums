...
enum{
  ...
  EOB_EVOLVE_X1,            /**< index of X1 */
  EOB_EVOLVE_X2,            /**< index of X2 */
  EOB_EVOLVE_CHI1,          /**< index of chi1 */
  EOB_EVOLVE_CHI2,          /**< index of chi2 */
  EOB_EVOLVE_NVARS         /**< number of EOB evolved variables */
};
static const char* eob_evolve_var[] = {"r","phi","Prstar","Pphi","X1","X2","chi1","chi2"};
...
enum{
  ...
  EOB_ID_X1,           /**< index of X1 */
  EOB_ID_X2,           /**< index of X2 */
  EOB_ID_CHI1,         /**< index of chi1 */
  EOB_ID_CHI2,         /**< index of chi2 */
  EOB_ID_NVARS         /**< number of EOB variables for initial data */
};
static const char* eob_id_var[] = {"r","phi","Pphi","Prstar","Pr","j","E0","Omega","X1","X2","chi1","chi2"};
...
enum{
  ...
  EOB_X1,                /**< index of X1 */
  EOB_X2,                /**< index of X2 */
  EOB_CHI1,              /**< index of chi1 */
  EOB_CHI2,              /**< index of chi2 */
  EOB_DYNAMICS_NVARS     /**< number of EOB dynamical variables */
};
static const char* eob_var[] = {"r","phi","Pphi","MOmega","ddor","Prstar","MOmega_orb","E", "flux_inf", "flux_hor", "X1","X2","chi1","chi2"};
...
/* binary parameters */
  ...
  int backwards;
  int horizon_evolution;                                /**< Flag to evolve horizon (yes/no) */
  /* final state */
...
int eob_dyn_rhs_ecc_horizon(double t, const double y[], double dy[], void *params);
...
void eob_flx_Flux_ecc(double nu, double chi1, double chi2, double X1, double X2, double a1, double a2, double C_Q1, double C_Q2, double C_Oct1, double C_Oct2, double C_Hex1, double C_Hex2,
...
double eob_flx_Fr_ecc(double nu, double a1, double a2, double aK2, double C_Q1, double C_Q2, double C_Oct1, double C_Oct2, double C_Hex1, double C_Hex2, double r, double prstar, double pphi, Dynamics *dyn, double Fphi_qc);
double eob_flx_Fr_ecc_BD(double nu, double a1, double a2, double aK2, double C_Q1, double C_Q2, double C_Oct1, double C_Oct2, double C_Hex1, double C_Hex2, double r, double prstar, double pphi, Dynamics *dyn, double Fphi_qc);
double eob_flx_Fr_ecc_next(double nu, double a1, double a2, double aK2, double C_Q1, double C_Q2, double C_Oct1, double C_Oct2, double C_Hex1, double C_Hex2, double r, double prstar, double pphi, Dynamics *dyn, double Fphi_qc);
...
extern double (*eob_flx_HorizonFlux_s_energy)(); /* defined in TEOBResumSPars.c */
double eob_flx_HorizonFlux_s_total(double x, double r, double prstar, double pphi, double Heff, double jhat, double nu, double X1, double X2, double chi1, double chi2, double Fphi_lo);
double eob_flx_HorizonFlux_s_LO_i(double x, double r, double prstar, double pphi, double Heff, double jhat, double nu, double X1, double X2, double chi1, double chi2, double Fphi_lo);
double eob_flx_HorizonFlux_s_LO_r_i(double x, double r, double prstar, double pphi, double Heff, double jhat, double nu, double X1, double X2, double chi1, double chi2, double Fphi_lo);
double eob_flx_HorizonFlux_s_NLO_i(double x, double r, double prstar, double pphi, double Heff, double jhat, double nu, double X1, double X2, double chi1, double chi2, double Fphi_lo);
double eob_flx_HorizonFlux_s_NNLO_i(double x, double r, double prstar, double pphi, double Heff, double jhat, double nu, double X1, double X2, double chi1, double chi2, double Fphi_lo);
double eob_flx_HorizonFlux_s_NNLO_fact_i(double x, double r, double prstar, double pphi, double Heff, double jhat, double nu, double X1, double X2, double chi1, double chi2, double Fphi_lo);
...
double eob_flx_HorizonFlux_s_LO_i(double x, double r, double prstar, double pphi, double Heff, double jhat, double nu, double X1, double X2, double chi1, double chi2, double Fphi_lo);
double eob_flx_HorizonFlux_s_NLO_energy_i(double x, double r, double prstar, double pphi, double Heff, double jhat, double nu, double X1, double X2, double chi1, double chi2, double Fphi_lo);
double eob_flx_HorizonFlux_s_NNLO_energy_i(double x, double r, double prstar, double pphi, double Heff, double jhat, double nu, double X1, double X2, double chi1, double chi2, double Fphi_lo);
double eob_flx_HorizonFlux_s_NNLO_fact_energy_i(double x, double r, double prstar, double pphi, double Heff, double jhat, double nu, double X1, double X2, double chi1, double chi2, double Fphi_lo);
