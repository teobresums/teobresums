...
{  
  ...
  d2sqrtAbyB_d2r = -0.25*sqrtAbyB*SQ(dA*B - A*dB)/(sqA*sqB) + 0.5/sqrtAbyB*(d2A*sqB - A*B*d2B - 2.*dA*dB*B + 2.*A*SQ(dB))/(SQ(B)*B);
  ...
  for(int n = 1; n <= iter; n++){
   ...
   r2dot = dsqrtAbyB_dr/sqrtAbyB*rdot2 + sqrtAbyB*
