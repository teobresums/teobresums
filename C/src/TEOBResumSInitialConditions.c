...
#define N (6)
  ...
  for (i = 0; i < N; i++) {
    ...
    pph[i] = s_bisec(pphorb,rorb,A[i],dA[i],rc[i],drc[i],aK2,S,Ss,params);// FIXME
  ...
  for (i = 0; i < N; i++) {    
    ...
    s_GS(r[i], rc[i], drc_dr[i], aK2, 0, pph[i], nu, chi1, chi2, X1, X2, c3);
    double GS_0                   = ggm0[2];
    double GSs_0                  = ggm0[3];
...
// /////////////////////////////////////
// /////////////////////////////////////
// FOLLOWING NEED TO BE CONVERTED
// /////////////////////////////////////
// /////////////////////////////////////
