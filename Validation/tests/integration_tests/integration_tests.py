...
params = {
        ...
        'test_parameters_perturb'    : [ ((40., 20., 0.8, 0.5, 0., 0.),        1e-3, 3, [1e-10, 1e-11]),  #BBH
                                         ((1.7, 1.,  0.2, 0.1, 400, 1500.),    1e-3, 3, [1e-10, 1e-11]),  #BNS
                                         ((6., 1.4,  0.8, 0.1, 0., 1500.),     1e-3, 3, [1e-10, 1e-11])], #BHNS
