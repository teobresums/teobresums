 ...
 *
 * \brief Main header for TEOBNR waveforms. This is the only header 
 * that should be used to access and generate TEOBNR waveforms.
 */
...
#ifndef _LALSIMIMRTEOB_H
#define _LALSIMIMRTEOB_H

static int XLALSimIMRTEOB(  REAL8TimeSeries **hplus,                     /**< [out] Time-domain waveform h+ */
                            REAL8TimeSeries **hcross,                    /**< [out] Time-domain waveform h+ */
